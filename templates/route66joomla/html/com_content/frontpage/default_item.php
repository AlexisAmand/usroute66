...
<?php ob_start(); ?> <?php JText::printf('Auteur: %s', ($this->item->created_by_alias ? $this->item->created_by_alias : $this->item->author) ); ?>
<?php $metadata[] = ob_get_clean(); ?>
<?php endif; ?>
...
<?php if ( intval($this->item->modified) != 0 && $this->item->params->get('show_a_date')) : ?>
<p class="modifydate">
